  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-violet': 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #a855f7 100%)',
        'gradient-blue-violet': 'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%)',
        'gradient-subtle': 'linear-gradient(180deg, rgba(139, 92, 246, 0.05) 0%, rgba(255, 255, 255, 0) 100%)',
      },
      animation: {
